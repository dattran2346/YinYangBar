 ...
 * been moved.
 */
public class YinYangBar extends View {

    // Member Variables ////////////////////////////////////////////////////////

    private static final String TAG = "YinYangBar";
    ...
    public YinYangBar(Context context) {
        super(context);
    }
...
//        }
    ...
    private void yinyangBarInit(Context context, AttributeSet attrs) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.YinYangBar, 0, 0);
        ...
        try {
            ...
            final float tickStart = ta
                    .getFloat(R.styleable.YinYangBar_tickStart, DEFAULT_TICK_START);
            final float tickEnd = ta
                    .getFloat(R.styleable.YinYangBar_tickEnd, DEFAULT_TICK_END);
            final float tickInterval = ta
                    .getFloat(R.styleable.YinYangBar_tickInterval, DEFAULT_TICK_INTERVAL);
            ...
            mCircleSize = ta.getDimension(R.styleable.YinYangBar_selectorSize,
                    TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, DEFAULT_CIRCLE_SIZE_DP,
                            getResources().getDisplayMetrics())
            );
            mCircleColor = ta.getColor(R.styleable.YinYangBar_selectorColor,
                    DEFAULT_CONNECTING_LINE_COLOR);
            mActiveCircleColor = mCircleColor;
            mTickColor = ta.getColor(R.styleable.YinYangBar_tickColor, DEFAULT_TICK_COLOR);
            mActiveTickColor = mTickColor;
            mConnectingLineWeight = ta.getDimension(R.styleable.YinYangBar_connectingLineWeight,
                    DEFAULT_CONNECTING_LINE_WEIGHT_PX);
            mConnectingLineColor = ta.getColor(R.styleable.YinYangBar_connectingLineColor,
                    DEFAULT_CONNECTING_LINE_COLOR);
            mActiveConnectingLineColor = mConnectingLineColor;
            mExpandedPinRadius = ta
                    .getDimension(R.styleable.YinYangBar_pinRadius, TypedValue.applyDimension(
            ...
            float density = getResources().getDisplayMetrics().density;
            mMinPinFont = ta.getDimension(R.styleable.YinYangBar_pinMinFont,
...
//            }
    ...
    public static interface OnRangeBarTextListener {
        ...
        public String getPinValue(YinYangBar rangeBar, int tickIndex);
    }
